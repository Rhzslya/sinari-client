    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <div className="space-y-2 sm:space-y-3 text-center">
            <DialogTitle className="text-lg sm:text-xl">
              {t("products_management.forms.restore.title")}
            </DialogTitle>
            <DialogDescription className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
              {t("products_management.forms.restore.desc_1")}{" "}
              <span className="font-bold text-foreground">{product?.name}</span>{" "}
              {t("products_management.forms.restore.desc_2")}
            </DialogDescription>
          </div>
        </DialogHeader>
        ...
        <DialogFooter className="mt-6 sm:mt-8 flex-col sm:flex-row gap-2 sm:gap-3 sm:justify-between w-full">
          ...
          >
            {t("products_management.forms.restore.btn_cancel")}
          </Button>
