...
const NotFoundPage = ({
  ...
  if (variant === "glass") {
    return (
      <div
        className={cn(
          "relative flex w-full flex-col items-center justify-center overflow-hidden bg-background text-center text-foreground",
          heightClass,
        )}
      >
        ...
        <div className="relative z-10 w-full max-w-md px-4 animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button
              ...
              className="min-w-30 text-foreground cursor-pointer duration-300"
            >
  ...
  if (variant === "split") {
    return (
      <div
        className={cn(
          "flex w-full overflow-hidden border bg-background text-foreground",
      ...
      >
        ...
        <div className="hidden w-1/2 bg-muted lg:block relative overflow-hidden border-l border-border">
          <div
            className="absolute inset-0 opacity-[0.15] text-foreground"
            style={{
              backgroundImage:
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-10">
            <Map className="h-64 w-64 text-foreground" />
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-col items-center justify-center bg-background p-4 text-center",
        heightClass,
      )}
    >
      <h1 className="select-none text-[10rem] font-black leading-none text-foreground/5 sm:text-[12rem] md:text-[14rem]">
        404
      </h1>
